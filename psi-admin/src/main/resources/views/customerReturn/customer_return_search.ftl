...
<html>
    ...
    <body class="layuimini-container">
        ...
        <div class="layui-fluid">
            <div class="layui-row layui-col-space15">
                ...
                <div class="layui-col-sm12 layui-col-md4 layui-col-lg3" style="width: 60%">
                    ...
                    <table id="customerReturnList" class="layui-table"
                           lay-filter="customerReturnList"></table>
                ...
                <div class="layui-col-sm12 layui-col-md8 layui-col-lg9" style="width: 40%">
                            ...
                            <div class="layui-col-xs4">
                                ...
                                <div class="layui-input-block">
                                    <input type="text" class="layui-input customerReturnNumber_"
                                           name="customerReturnNumber_" id="customerReturnNumber_"
                                           readonly="readonly">
                                </div>
                            </div>
                            <div class="layui-col-xs4">
                                ...
                                <div class="layui-input-block">
                                    <input type="text" class="layui-input customerName"
                                           name="customerName_" id="customerName_"
                                           readonly="readonly">
                                </div>
                            </div>
                            <div class="layui-col-xs4">
                                ...
                                <div class="layui-input-block">
                                    <input type="text" class="layui-input purchaseNumber"
                                           name="amountPayable_" id="amountPayable_"
                                           readonly="readonly">
                                </div>
                            </div>
                        </div>
                    ...
                    <table id="customerReturnListGoods" class="layui-table"
                           lay-filter="customerReturnListGoods"></table>
                    </form>
                </div>
            </div>
        </div>
        ...
        <script type="text/javascript"
                src="${ctx.contextPath}/js/customerReturn/customer.return.search.js"></script>
    </body>
</html>