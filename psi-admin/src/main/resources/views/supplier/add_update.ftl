            ...
            <div class="layui-form-item layui-row layui-col-xs12">
                ...
                <div class="layui-input-block">
                    <input type="text" class="layui-input contact"
                           lay-verify="required" name="contact" id="contact" value="${(supplier.contact)!}"
                           placeholder="请输入联系人">
                </div>
            </div>
            <div class="layui-form-item layui-row layui-col-xs12">
                ...
                <div class="layui-input-block">
                    <input type="text" class="layui-input userName"
                           lay-verify="required" name="phone" id="phone" value="${(supplier.phone)!}"
                           placeholder="请输入联系电话">
                </div>
            </div>
            <div class="layui-form-item layui-row layui-col-xs12">
                ...
                <div class="layui-input-block">
                    <input type="text" class="layui-input userName"
                           lay-verify="required" name="address" id="address" value="${(supplier.address)!}"
                           placeholder="请输入联系地址">
                </div>
            </div>
            <br/>
