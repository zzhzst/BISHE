                    ...
                    <div class="layui-col-xs6">
                        ...
                        <div class="layui-input-block">
                            <input type="text" class="layui-input purchasingPrice"
                                   name="purchasingPrice000" id="purchasingPrice" readonly="readonly"
                                   value="${(goods.purchasingPrice)!}">
                        </div>
                    </div>
                </div>
            </fieldset>
                ...
                <div class="layui-col-xs6">
                    ...
                    <div class="layui-input-block">
                        <input type="text" class="layui-input inventoryQuantity"
                               name="inventoryQuantity" id="inventoryQuantity" lay-verify="required"
                               placeholder="请输入库存数"
