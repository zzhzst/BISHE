    ...
    <body class="childrenBody">
        <form class="layui-form" style="width:80%;">
            ...
            <div class="layui-form-item layui-row layui-col-xs12">
                <label class="layui-form-label required" style="color: red">商品类别</label>
                <div class="layui-input-block">
					...
					searchVal" placeholder="商品类别" readonly="readonly" value="${(goodsType.name)!""}"/>
                        ...
                        <a class="layui-btn search_btn" data-type="reload" href="javascript:void(0)"
                           id="reloadGoodsType"><i
            ...
            <br/>
            <div class="layui-form-item layui-row layui-col-xs12">
                <label class="layui-form-label required" style="color: red">商品名</label>
                <div class="layui-input-block">
                ...
                <div class="layui-col-xs6">
                    ...
                    <div class="layui-input-block">
                        <input type="text" class="layui-input sellingPrice"
                               lay-verify="required" name="sellingPrice" id="sellingPrice"
            ...
            <div class="layui-row">
                <div class="layui-col-xs6">
                    <label class="layui-form-label required" style="color: red">商品单位</label>
                    <div class="layui-input-block">
