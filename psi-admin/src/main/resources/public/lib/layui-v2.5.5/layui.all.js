...
!function (e, t) {
    ...
    function $(e, t, n) {
        ...
        for (I(c, l.opts.specialEasing); o < a; o++) if (r = $.prefilters[o].call(l, e, c, l.opts)) return pe.isFunction(r.stop) && (pe._queueHooks(l.elem, l.opts.queue).stop = com.xxxx.crm.proxy(r.stop, r)), r;
