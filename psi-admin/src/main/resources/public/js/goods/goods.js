layui.use(['element', 'table', 'layer'], function () {
    ...
    var tableIns = table.render({
        ...
        id: "goodsListTable",
        cols: [[
            {type: "checkbox", fixed: "left", width: 50, sort: true},
            ...
            {field: 'purchasingPrice', title: '采购价', minWidth: 100, align: 'center', sort: true},
            {field: 'sellingPrice', title: '出售价', minWidth: 100, align: 'center', sort: true},
            {field: 'minNum', title: '库存下限', minWidth: 100, align: 'center', sort: true},
            {field: 'producer', title: '生产厂商', align: 'center', minWidth: 150, sort: true},
