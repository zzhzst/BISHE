layui.use(['table', 'layer', "form"], function () {
    ...
    var tableIns = table.render({
        ...
        cols: [[//表头
            ...
            {field: 'username', title: '用户名', minWidth: 50, align: "center", sort: true},
            {field: 'trueName', title: '真实姓名', align: 'center', sort: true},
            {field: 'sex', title: '性别', align: 'center', sort: true},
            {field: 'phone', title: '手机', minWidth: 100, align: 'center', sort: true},
            {field: 'remarks', title: '备注', align: 'center', minWidth: 150, sort: true},
