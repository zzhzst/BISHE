layui.use(['element', 'table', 'layer'], function () {
    ...
    var tableIns01 = table.render({
        ...
        cols: [[
            ...
            {field: 'code', title: '商品编码', minWidth: 50, align: "center", sort: true},
            {field: 'name', title: '商品名称', minWidth: 100, align: 'center', sort: true},
            {field: 'model', title: '商品型号', minWidth: 100, align: 'center', sort: true},
            {field: 'typeName', title: '商品类别', minWidth: 100, align: 'center', sort: true},
            {field: 'unitName', title: '单位', minWidth: 100, align: 'center', sort: true},
    ...
    $(".search_btn2").on("click", function () {
        table.reload("goodsListTable02", {
            page: {
                curr: 1 //重新从第 1 页开始
            },
            where: {
                goodsName: $("input[name='goodsName2']").val()
            }
        })
    });
    ...
    var tableIns02 = table.render({
        ...
        cols: [[
            ...
            {field: 'code', title: '商品编码', minWidth: 50, align: "center", sort: true},
            {field: 'name', title: '商品名称', minWidth: 100, align: 'center', sort: true},
            {field: 'model', title: '商品型号', minWidth: 50, align: 'center', sort: true},
            {field: 'typeName', title: '商品类别', minWidth: 50, align: 'center', sort: true},
            {field: 'unitName', title: '单位', align: 'center', sort: true},
            {field: 'inventoryQuantity', title: '库存', minWidth: 50, align: 'center', sort: true},
            {field: 'purchasingPrice', title: '成本价(￥)', minWidth: 100, align: 'center', sort: true},
            {
                field: 'amount', title: '库存金额(￥)', minWidth: 120, align: 'center', sort: true, templet: function (d) {
