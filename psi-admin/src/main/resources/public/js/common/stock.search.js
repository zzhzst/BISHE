layui.use(['table', 'layer'], function () {
    ...
    var tableIns = table.render({
        ...
        cols: [[
            ...
            {field: 'purchasingPrice', title: '默认采购价(￥)', minWidth: 100, align: 'center'},
            {field: 'average', title: '库存均价(￥)', minWidth: 100, align: 'center'},
            {field: 'sellingPrice', title: '销售价(￥)', minWidth: 100, align: 'center'},
            {field: 'amount', title: '库存总金额(￥)', minWidth: 100, align: 'center'},
